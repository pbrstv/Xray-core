...
import (
	...
	database "github.com/xtls/xray-core/proxy/vless/database"
...
type Config struct {
	...
	ClientsStorage *database.ClientsStorage `protobuf:"bytes,8,opt,name=clients_storage,json=clientsStorage,proto3" json:"clients_storage,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *Config) GetClientsStorage() *database.ClientsStorage {
	if x != nil {
		return x.ClientsStorage
	}
	return nil
}
...
const file_proxy_vless_inbound_config_proto_rawDesc = "" +
	"\n" +
	" proxy/vless/inbound/config.proto\x12\x18xray.proxy.vless.inbound\x1a\x1acommon/protocol/user.proto\x1a!proxy/vless/database/config.proto\"\x82\x01\n" +
	"\bFallback\x12\x12\n" +
	...
	"\x04xver\x18\x06 \x01(\x04R\x04xver\"\xdb\x02\n" +
	"\x06Config\x124\n" +
	...
	"\apadding\x18\a \x01(\tR\apadding\x12C\n" +
	"\x0fclients_storage\x18\b \x01(\v2\x1a.xray.proxy.ClientsStorageR\x0eclientsStorageBj\n" +
...
var file_proxy_vless_inbound_config_proto_goTypes = []any{
	...
	(*database.ClientsStorage)(nil), // 3: xray.proxy.ClientsStorage
}
var file_proxy_vless_inbound_config_proto_depIdxs = []int32{
	...
	3, // 2: xray.proxy.vless.inbound.Config.clients_storage:type_name -> xray.proxy.ClientsStorage
